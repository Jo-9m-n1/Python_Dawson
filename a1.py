...
print('Your grade is: ', round(float((int(L_G)) * 0.20) + (int(Q_G) * 0.15) + ((((float(A1) + float(A2) + float(A3) + float(A4)) / 4) * 0.16) + (((float(M1) + float(M2)) / 2) * 0.25) + ((float(FI)) * 0.18) + ((float(MF)) * 0.06))))
